---
name: react-data
description: 当前模板的数据访问和状态管理规范。编写 API、TanStack Query、Mutation、Zustand、URL 搜索状态、OpenAPI 生成代码或 options 时使用。
---
...
简单业务把 Query Key、Query、Mutation 放在页面附近一个 `<name>.query.ts`：
